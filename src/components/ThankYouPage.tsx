      ...
      <div className="flex-grow flex flex-col items-center pt-4 pb-12 px-4 w-full">
        ...
        <div className="max-w-2xl w-full flex flex-col items-center text-center mb-8">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-[#824ca7] mb-2 leading-tight">
            Das hat funktioniert. In etwa 10 Minuten ist die Anleitung in Deinem E-Mail-Postfach.
          </h1>
          ...
          <p className="text-base md:text-lg text-gray-600 mb-6 max-w-lg [text-wrap:balance] leading-relaxed">
            In etwa 10 Minuten bekommst Du eine Bestätigungs-E-Mail von uns. Sobald Du Deine E-Mail bestätigt hast, senden wir Dir alle Inhalte zu.
          </p>
        ...
        <div className="w-full flex flex-col items-center animate-fade-in-up delay-200">
          <h2 className="text-lg md:text-xl font-bold mb-2 text-center bg-gradient-to-br from-gray-800 via-[#7a3e9d] to-[#824ca7] bg-clip-text text-transparent px-2 leading-tight">
            <span className="underline decoration-yellow-400 decoration-4 underline-offset-2">Wenn Du schon hier bist,</span> fülle gerne unseren Coaching-Fragebogen aus, solange Du auf Deine Inhalte wartest
          </h2>
          <p className="text-base text-gray-600 mb-6 text-center px-4">
            In einem unverbindlichen Erstgespräch können wir persönlich über Deine Situation sprechen.
          </p>
